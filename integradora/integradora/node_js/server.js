...
app.post('/producto/registrar', (req, res)=>{
    ...
    const sql = "INSERT INTO productos (Nombre, tipo, Categoria, precio, estatus) VALUES (?, ?, ?, ?, ?)";
...
app.put('/producto/modificar/:id', (req, res)=>{
    ...
    const sql = "UPDATE productos SET Nombre = ?, tipo = ?, Categoria = ?, precio = ?, estatus = ? WHERE ID_product = ?";
...
app.delete("/producto/eliminar/:id", (req, res)=>{
    ...
    const sql = 'DELETE FROM productos WHERE ID_product = ?';
    db.query(sql, [id], (err, result)=>{
        if(err) {
            res.status(500).send(err);
        }else {
...
app.post('/zona/registrar', (req, res)=>{
    ...
    const sql = "INSERT INTO zonas (nombre_colonia, costo_zona) VALUES (?, ?)";
...
app.put('/zona/modificar/:id', (req, res)=>{
    ...
    const sql = "UPDATE zonas SET nombre_colonia = ?, costo_zona = ? WHERE ID_zona = ?";
