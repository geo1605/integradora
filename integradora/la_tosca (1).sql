...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-10-2024 a las 04:11:54
...
INSERT INTO `direccion` (`id_direccion`, `calle`, `numero`, `colonia`, `estatus`, `id_zona`, `ID_cliente`) VALUES
(1, 'Calle A', '101', 'Colonia A', 0, 1, 1),
(2, 'Calle B', '202', 'Colonia B', 0, 2, 2),
(3, 'Calle C', '303', 'Colonia C', 0, 3, 3),
(4, 'Calle D', '404', 'Colonia D', 0, 4, 4),
(5, 'Calle E', '505', 'Colonia E', 0, 5, 5);
...
(1, 'Ana', 'Méndez', 'Ríos', 'admin', '', '5556789012', 'admin', 1),
...
(1, 'Producto A', 'suelto', 'Categoria 1', 100.00, 2),
(2, 'Producto B', 'unitario', 'Categoria 2', 75.00, 2),
(3, 'Producto C', 'suelto', 'Categoria 3', 50.00, 1),
(4, 'Producto D', 'unitario', 'Categoria 1', 120.00, 2),
(5, 'Producto E', 'suelto', 'Categoria 2', 90.00, 2);
